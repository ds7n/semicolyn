...
| 12 | **Privacy statement** content (drilled-down from About & Help) is load-bearing for Neotilde's marketed posture but has no draft. Worth a content pass before code so App Store submission isn't blocked. | medium | resolved | `2026-06-17-privacy-statement-design.md` |
