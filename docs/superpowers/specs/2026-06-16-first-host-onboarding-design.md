...
forced tutorials, while making Semicolyn's distinctive gesture vocabulary
...
4. **Context-aware promotions**
   When the foreground process is something Semicolyn recognises (vim, less,
