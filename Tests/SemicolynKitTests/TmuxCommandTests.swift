...
final class TmuxCommandTests: XCTestCase {
    ...
    func testKillSessionValidSemicolynName() {
        XCTAssertEqual(TmuxCommand.killSession(name: "semicolyn-a3f7c2e9"),
                       "kill-session -t semicolyn-a3f7c2e9")
    }

    func testKillSessionValidAltName() {
        XCTAssertEqual(TmuxCommand.killSession(name: "semicolyn-a3f7c2e9-1b4d"),
                       "kill-session -t semicolyn-a3f7c2e9-1b4d")
    }
    ...
    func testKillSessionRejectsWhitespace() { // injection vector: arg split
        XCTAssertNil(TmuxCommand.killSession(name: "semicolyn foo"))
    }
