...
/// mouse-off sends the `cyclePane` private sequence. The single source of truth for the branch.
final class TapPaneRouteTests: XCTestCase {
    ...
    func testMouseOffCyclesPane() {
        XCTAssertEqual(tapPaneRoute(mouseModeOn: false), .cyclePane)
    }
}
