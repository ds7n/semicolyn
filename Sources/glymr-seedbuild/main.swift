...
///
/// Usage: `glymr-seedbuild --out <dir> [--tldr <dir>] [--fig <dir>]`
...
let usage = "usage: glymr-seedbuild --out <dir> [--tldr <dir>] [--fig <dir>]"
...
guard let outPath = options["--out"] else {
    fail("usage: glymr-seedbuild --out <dir> [--tldr <dir>] [--fig <dir>]")
}
