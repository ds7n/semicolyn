...
/// `mosh.*` Glymr extension. `udpPortRange` is a two-element `[lo, hi]` (the
...
/// `glymr.predictor.*` — per-host predictor controls.
...
/// `glymr.tmux.*` — per-host tmux controls.
...
/// `glymr.*` Glymr-namespaced extension bundle.
public struct GlymrConfig: Codable, Equatable, Sendable {
