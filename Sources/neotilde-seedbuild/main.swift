...
///
/// Usage: `neotilde-seedbuild --out <dir> [--tldr <dir>] [--fig <dir>]`
...
let usage = "usage: neotilde-seedbuild --out <dir> [--tldr <dir>] [--fig <dir>]"
...
guard let outPath = options["--out"] else {
    fail("usage: neotilde-seedbuild --out <dir> [--tldr <dir>] [--fig <dir>]")
}
